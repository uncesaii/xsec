...
_GUEST_RUNNER = "/usr/local/sbin/xverse-hyperv-guest-runner"
    ...
    def prepare_dump(
        ...
        *,
        ...
        script = (
            ...
            "$archive=Join-Path $dir 'xverse-archive';"
            "$archived='';"
    ...
    def collect_dump(
        ...
        *,
        ...
        script = (
            ...
            "ToLowerInvariant();"
            "$evidenceDir=Join-Path (Split-Path -Parent $dump) 'xverse-evidence';"
